...
parse_token_bazos = "Отравьте bkod из куки bazos!\n" \
                    "Можно отправить сразу несколько, каждое значение на новой строке"
parse_proxy = 'Отправьте ваш прокси в формате: login:password@ip:port'
bad_parse_proxy = 'Неверный формат прокси'
parse_skip_tops = """\
Пропускать TOP объявления?
"""
parse_skip_tops_invalid = "Неверный формат ответа"
bad_connect_parse_proxy = 'Не удалось подключиться к прокси'

bazos_ends = """\
Объявления не подошедшие
По цене объявления: {price}
По дате объявления: {post_date}
По кол-ву постов: {max_posts}
По просмотрам: {max_views}
Слово в чс: {ban_word}
Обьявление в чс: {ban_post}
Другая причина: {anythink}

Всего пропущено: {all_count}
"""

bazos_settings = """
Имя: <b>{name}</b>
Рамки цены: <b>{price} {currency}</b>
Кол-во обьявлений у продавца: <b>{max_posts}</b>
Кол-во просмотров: <b>{max_views}</b>
Дата выпуска объявления: <b>{post_date}</b>
Пропускать TOP объявления: <b>{skip_tops}</b>
"""
